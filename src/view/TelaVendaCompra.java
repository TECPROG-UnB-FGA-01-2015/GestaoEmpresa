...
public class TelaVendaCompra extends javax.swing.JFrame
{
	...
	{
		JOptionPane.showMessageDialog(this, info, "Atenção",
				JOptionPane.INFORMATION_MESSAGE);
	}

	/* This method is responsible to display a GUI so that the User can choose the Clients/Providers' names 
	 * search products' names, add products, remove products, buy and sell products according to their quantities
	 */
																										...
																										.addGroup(
																												jPanel1Layout
																														.createParallelGroup(
																																javax.swing.GroupLayout.Alignment.LEADING)
																														.addComponent(
																																jTextField_NomeFuncionario)
																														.addComponent(
																																jTextField_NomeClienteFornecedor)
																														.addComponent(
																																jTextField_DescricaoProduto)))
																						.addGroup(
																								javax.swing.GroupLayout.Alignment.LEADING,
																								jPanel1Layout
																										.createSequentialGroup()
	...
	/* This method is responsible to load and show on the screen the Product's list info 
	 * (Code, Description, Quantity, Shopping/Sale Price and Total Price) 
	 */
	...
	/* This method is responsible to display the Client's name when the chosen operation was
	 * "Selling" and the Provider's name when the chosen operation was "Shopping"
	 */
	...
	private void jButton_FinalizarActionPerformed(java.awt.event.ActionEvent evt)
	{
		...
		else
		{
			for (Produto p : listaTabelaProduto)
			{
				if (statusVendaCompra == 0)
				{
					Produto f = umControleEstoque.pesquisarProduto(
							p.getCodigo(), false);
