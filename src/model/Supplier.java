...
public class Supplier
{
	...
	protected String telephone; // Describes the telephone of the supplier (only numbers; example: 6132765432)
	protected String cellphone; // Describes the telephone of the supplier (only numbers; example: 6132765432)
